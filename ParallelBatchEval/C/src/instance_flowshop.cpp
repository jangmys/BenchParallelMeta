...
int
instance_flowshop::get_job_number(int id)
{
...
int
instance_flowshop::get_machine_number(int id)
{
    if (id > 110) return 20;
...
long
instance_flowshop::unif(long * seed, long low, long high)
{
...
void
instance_flowshop::generate_instance(int id, std::ostream& stream)
{
    ...
    stream << N << " " << M << " ";
    for (int j = 0; j < M; j++) for (int i = 0; i < N; i++) stream << unif(&time_seed, 1, 99) << " ";
}


instance_flowshop::instance_flowshop(const char * inst_name)
{
